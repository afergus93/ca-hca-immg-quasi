...
epi.2by2(unad.strat, method = "cross.sectional")
...
epi.2by2(sex.strat.m, method = "cross.sectional")
epi.2by2(sex.strat.f, method = "cross.sectional")
...
race.strat.Hisp <- with(subset(df, race == "Hispanic, Latino/a, or Spanish origin"),
                     table(ment14d, mj30day))
race.strat.Mult <- with(subset(df, race == "Non-Hispanic Multiracial"),
                     table(ment14d, mj30day))
...
insurance.strat.y <- with(subset(df, hlthpln1 = "Yes"),
                        table(ment14d, mj30day))
insurance.strat.n <- with(subset(df, hlthpln1 = "No"),
                        table(ment14d, mj30day))

epi.2by2(insurance.strat.y, method = "cross.sectional")
epi.2by2(insurance.strat.n, method = "cross.sectional")
