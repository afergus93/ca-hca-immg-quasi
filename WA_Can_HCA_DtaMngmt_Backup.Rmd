...
df <- df %>%
  filter(!is.na(mj30day) & !is.na(medcost) & !is.na(X_ment14d)) %>% # filter out any missingness associated with exposure/outcome
...
write.csv(df, "data/WA_2015_2019_BRFSS_Clean.csv", row.names = FALSE)
