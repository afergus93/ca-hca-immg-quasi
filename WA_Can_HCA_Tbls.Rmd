...
t1 <- tbl_svysummary(db, by = mj30day, percent = "row",
...
t1.alt.medcost <- tbl_svysummary(db, by = dHCA, percent = "row",
...
t1.alt.ment14d <- tbl_svysummary(db, by = mentComp, percent = "row",
